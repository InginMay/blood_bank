...
<div class="container-fluid mt-4">
    <div class="row">
      <div class="col-12">
        <img src="<?php echo e(asset('image/contactme.jpg')); ?>" style="width: 500px;height: 500px;margin-left: 300px;">
      </div>
    </div>
  </div>
...
<?php echo $__env->make('frontendtemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/blood_donation/resources/views/frontend/contact.blade.php ENDPATH**/ ?>