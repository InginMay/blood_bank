 ...
 <div class="container my-5">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-12 my-3">
        <img src="<?php echo e(asset('blood/images/download.png')); ?>" width="230" height="250" data-toggle="modal" data-target="#AModel">
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 my-4">
        <img src="<?php echo e(asset('blood/images/dd.png')); ?>" width="210" height="240" data-toggle="modal" data-target="#BModel">
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 my-4">
        <img src="<?php echo e(asset('blood/images/bb.png')); ?>" width="250" height="240" data-toggle="modal" data-target="#ABModel">
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 my-4">
        <img src="<?php echo e(asset('blood/images/oo.png')); ?>" width="250" height="240" data-toggle="modal" data-target="#OModel">
      </div>
    </div>
</div>
        ...
        <div class="col-md-8 offset-2 card shadow">
          ...
          <div class="row">
            <div class="col-12 my-5">
              <h1 align="center">သင်သွေးလှူရှင်ဖြစ်နိုင်ပါသလား</h1>
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12">
              <img src="<?php echo e(asset('blood/images/download.png')); ?>" class="img-fluid" style="width: 400px;height: 300px;">
            </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12">
              <img src="<?php echo e(asset('blood/images/dd.png')); ?>" class="img-fluid" style="width: 400px;height: 300px;">
            </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12">
              <img src="<?php echo e(asset('blood/images/bb.png')); ?>" class="img-fluid" style="width: 400px;height: 300px;">
            </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12">
              <img src="<?php echo e(asset('blood/images/oo.png')); ?>" class="img-fluid" style="width: 400px;height: 300px;">
            </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
...
<?php echo $__env->make("frontendtemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/blood_donation/resources/views/frontend/main.blade.php ENDPATH**/ ?>