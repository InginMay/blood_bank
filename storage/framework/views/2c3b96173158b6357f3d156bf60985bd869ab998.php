 ...
 <div class="container my-5">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-12 my-3">
        <img src="<?php echo e(asset('image/a1.png')); ?>" width="160" height="260" data-toggle="modal" data-target="#AModel">
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 my-4">
        <img src="<?php echo e(asset('image/b1.png')); ?>" width="150" height="250" data-toggle="modal" data-target="#BModel">
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 my-4">
        <img src="<?php echo e(asset('image/ab2.png')); ?>" width="180" height="250" data-toggle="modal" data-target="#ABModel">
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 my-4">
        <img src="<?php echo e(asset('image/o.png')); ?>" width="150" height="250" data-toggle="modal" data-target="#OModel">
      </div>
    </div>
</div>
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12">
              <img src="<?php echo e(asset('image/a1.png')); ?>" class="img-fluid" style="width: 250px;height: 300px;">
            </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12">
              <img src="<?php echo e(asset('image/b1.png')); ?>" class="img-fluid" style="width: 200px;height: 300px;">
            </div>
                <div class="col-lg-8 col-md-12 col-sm-12">
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12">
              <img src="<?php echo e(asset('image/ab2.png')); ?>" class="img-fluid" style="width: 250px;height: 300px;">
            </div>
                <div class="col-lg-8 col-md-12 col-sm-12">
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12">
              <img src="<?php echo e(asset('image/o.png')); ?>" class="img-fluid" style="width: 200px;height: 300px;">
            </div>
                <div class="col-lg-8 col-md-12 col-sm-12">
