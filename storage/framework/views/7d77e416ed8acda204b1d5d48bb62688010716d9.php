...
<div class="container">
	...
	<div class="row">
		<div class="col-12">
			<form action="<?php echo e(route('donated.store')); ?>" method="post">
				<?php echo csrf_field(); ?>
...
<?php echo $__env->make('backendtemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blood_bank\resources\views/backend/donated/create.blade.php ENDPATH**/ ?>